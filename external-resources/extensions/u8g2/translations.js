...
function getInterfaceTranslations () {
    return {
        "es": {
            "u8g2.description": "U8g2 es una biblioteca gráfica general para múltiples pantallas, adecuada para pantallas LCD (basadas en ST7920) u OLED (basadas en SSD1306)."
        },
        "en": {
...
function registerBlocksMessages (Blockly) {
    Object.assign(Blockly.ScratchMsgs.locales["es"],
        {
            "U8G2_12832OLED_INIT": "iniciar u8g2 128x32 pin oled SCL %1 SDA %2",
            "U8G2_12864LCD_INIT": "iniciar u8g2 128x64 pin lcd RS (CS) %1 R/W (DATA) %2 E (CLK) %3",
            "U8G2_12864LCD_INIT_TOOLTIP": "Solo soporta controlador de pantalla ST7920.",
            "U8G2_12864OLED_INIT": "iniciar u8g2 128x64 pin oled SCL %1 SDA %2",
            "U8G2_CATEGORY": "U8G2",
            "U8G2_CLEAR": "u8g2 limpiar visor",
            "U8G2_COLOR_COLORED": "colorado",
            "U8G2_COLOR_NOCOLORED": "no colorado",
            "U8G2_DISPLAYROTATION_MIRROR": "espejo",
            "U8G2_DRAWCIRCLE": "u8g2 dibujar %1 círculo x: %2 y: %3 radio %4 parte %5",
            "U8G2_DRAWELLIPSE": "u8g2 dibujar %1 elipse x: %2 y: %3 ancho %4 alto %5 parte %6",
            "U8G2_DRAWLINE": "u8g2 dibujar línea x0: %1 y0: %2, x1: %3 y1: %4",
            "U8G2_DRAWPIXEL": "u8g2 dinujar pixel x: %1 y: %2",
            "U8G2_DRAWRECTANGLE": "u8g2 dibujar %1 rectángulo x: %2 y: %3 ancho %4 alto %5",
            "U8G2_DRAWROUNDRECTANGLE": "u8g2 dibujar %1 rectángulo redondeado x: %2 y: %3 ancho %4 alto %5 radio %6",
            "U8G2_DRAWSTRING": "u8g2 dibujar cadena %1 x: %2 y: %3",
            "U8G2_DRAWTRIANGLE": "u8g2 dibujar triángulo  x0: %1 y0: %2, x1: %3 y1: %4, x2: %5 y2: %6",
            "U8G2_DRAWVHLINE": "u8g2 dibujar %1 línea x: %2 y: %3 longitud %4",
            "U8G2_FONT_10X20": "X11 10x20",
            "U8G2_FONT_11X11C": "WQY 11x11 (soporta chino)",
            "U8G2_FONT_13X13C": "WQY 13x13 (soporta chino)",
            "U8G2_FONT_14X14C": "WQY 14x14 (soporta chino)",
            "U8G2_FONT_15X15C": "WQY 15x15 (soporta chino)",
            "U8G2_FONT_16X16C": "WQY 16x16 (soporta chino)",
            ...
            "U8G2_OLED_INIT_TOOLTIP": "Solo soporta controlador de pantalla oled SSD1306.",
            "U8G2_PART_ALL": "todo",
            "U8G2_PART_LOWER_LEFT": "abajo izquierda",
            "U8G2_PART_LOWER_RIGHT": "abajo derecha",
            "U8G2_PART_UPPER_LEFT": "arriba izquierda",
            "U8G2_PART_UPPER_RIGHT": "arriba derecha",
            "U8G2_PRINT": "u8g2 imprimir %1",
            "U8G2_REFRESH": "u8g2 refrescar visor",
            "U8G2_SETCURSOR": "u8g2 establecer posición de cursor x: %1 y: %2",
            "U8G2_SETDISPLAYROTATION": "u8g2 establecer rotación de visor %1",
            "U8G2_SETDRAWCOLOR": "u8g2 establecer color de dibujo %1",
            "U8G2_SETFONT": "u8g2 establecer fuente %1 dirección %2",
            "U8G2_SETFONT_TOOLTIP": "Limitado por el tamaño de la ROM, solo algunos caracteres chinos son compatibles. Puedes intentar introducirlos, si no son compatibles no se mostrarán.",
            "U8G2_STYLE_FILLED": "lleno",
            "U8G2_STYLE_HORIZONTAL": "horizontal",
            "U8G2_STYLE_NOFILLED": "no lleno",
